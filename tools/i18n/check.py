...
def main():
    ...
    parser.add_argument("--pot_file", default="httplint/translations/messages.pot", help="Path to POT file")
    parser.add_argument("--locale_dir", default="httplint/translations", help="Path to locale directory")
